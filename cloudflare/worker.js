...
import accessibilityHtml from '../public/accessibility.html';
...
export default {
  async fetch(request, env) {
    ...
    if (['/accessibility.html', '/accessibility', '/legal/accessibility'].includes(url.pathname)) return legalResponse(accessibilityHtml, 'text/html');
